...
const ProductCard = ({ product }) => {
  ...
  // Ensure price is parsed as a valid number
  const priceNumber = parseFloat(price);

  // If the price is a valid number, format it, otherwise set as 'N/A'
  ...
  return (
    <div className="bg-base p-4 rounded shadow">
      ...
      <p className="text-base-content-600">
        {/* Conditionally format price */}
        {price !== "N/A" ? `$${price}` : 'N/A'}
      </p>
      <Link
        to="/consumer/product"
